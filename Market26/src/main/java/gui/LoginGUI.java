...
public class LoginGUI extends JFrame {
	...
	public LoginGUI() {
		...
		textFieldName.setBounds(251, 37, 86, 20);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Emaitza b = facade.isLogged(textFieldName.getText(), passStr);
				if(b.getLog()) {
					new MainGUIErregistratua(b.getEmail(), b.getSeller()).setVisible(true);
				}
			}
		});
